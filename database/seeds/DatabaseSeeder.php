...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        factory(App\Models\District::class, 3)->create();
        factory(App\Models\Filial::class, 3)->create();
        factory(App\Models\Page::class, 10)->create();
        factory(App\Models\PackageType::class, 16)->create();
        factory(App\Models\Category::class, 8)->create();
        factory(App\Models\Country::class, 4)->create();
        factory(App\Models\Warehouse::class, 3)->create();
        factory(App\Models\Address::class, 3)->create();
        factory(App\Models\User::class, 27)->create();
