...
class ParcellingController extends Controller
{
    ...
    {
        $items = Parcel::with(['packages'])->withCount(['packages', 'waiting'])->whereHas('packages')->orderBy('sent', 'asc')->latest();
    ...
    {
        $parcel = Parcel::withCount(['packages'])->find($id);
        ...
        return view('admin.widgets.parcel_label', compact('parcel'));
    }
}
