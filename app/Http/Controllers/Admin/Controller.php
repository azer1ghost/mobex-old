...
class Controller extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->limit = \Request::get('limit') != null ? \Request::get('limit') : 25;
    ...
    public function panelView($blade)
    {
        ...
        return isset($this->{$viewDir}) ? $this->{$viewDir} : ($this->templateDir . '.' . $blade);
    }
                ...
                if (isset($field['pivot']) && $field['pivot']) {
                    ...
                    if (in_array($field['type'], ['image', 'file'])) {
                        if ($request->hasFile($field['name'])) {
                            $ext = $request->file($field['name'])->getClientOriginalExtension();
