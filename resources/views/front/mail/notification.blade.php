...
<head>
    ...
    <style>
        ...
        .email-body {
            ...
            border-bottom: 4px solid #019981;
        }
                ...
                <table class="email-header">
                    ...
                    <tr>
                        <td class="text-center pdb-2-5x">
                            <a href="#"><img class="email-logo" src="https://{{ env('DOMAIN_NAME')  }}/assets/images/logo-3.png"
                                             alt="logo"></a>
                        </td>
                    </tr>
                    </tbody>
                            ...
                            <ul class="email-social">
                                @if ($setting->facebook)
                                    <li><a href="{{ $setting->facebook }}"><img
                                                    src="{{ asset('email_assets/images/fb.png') }}?v=1" alt="brand"></a>
                                    </li>
                                @endif
                                @if ($setting->twitter)
                                    <li><a href="{{ $setting->twitter }}"><img src="{{ asset('email_assets/images/tw.png') }}?v=1"
                                                                               alt="brand"></a></li>
                                @endif
                                @if ($setting->instagram)
                                    <li><a href="{{ $setting->instagram }}"><img src="{{ asset('email_assets/images/ins.png') }}?v=1"
                                                                                 alt="brand"></a></li>
                                @endif
                                @if ($setting->linkedin)
                                    <li><a href="{{ $setting->linkedin }}"><img src="{{ asset('email_assets/images/li.png') }}?v=1"
                                                                                alt="brand"></a></li>
                                @endif
                            </ul>
                        </td>
