...
<div style="position:absolute;left:50%;margin-left:-297px;top:0px;width:595px;height:841px;overflow:hidden">
    ...
    <div style="position:absolute;left:112.00px;top:144.75px" class="cls_004"><span class="cls_004">:  &nbsp;&nbsp;322000</span></div>
    ...
    <div style="position:absolute;left:121.60px;top:159.60px" class="cls_008"><span class="cls_008">{{ ucfirst(str_slug(($item->warehouse && $item->warehouse->addresses && $item->warehouse->addresses()->first()) ? $item->warehouse->addresses()->first()->city : "-")) }}</span></div>
    ...
    <div style="position:absolute;left:121.60px;top:172.40px" class="cls_008"><span class="cls_008">{{ ($item->warehouse && $item->warehouse->country) ? (isset($item->warehouse->country->translate('en')->name) ? $item->warehouse->country->translate('en')->name : $item->warehouse->country->name) : "China" }}</span></div>
    ...
    <div style="position:absolute;left:121.60px;top:230.00px" class="cls_008"><span class="cls_008">{{ $item->user ? $item->user->full_name : "-" }}</span></div>
    ...
    <div style="position:absolute;left:121.60px;top:262.00px; height: 40px; width: 180px;" class="cls_008"><span class="cls_008">{{ $item->user ? str_slug($item->user->address, " ") : "-" }}</span></div>
    ...
    <div style="position:absolute;left:444.80px;top:303.60px" class="cls_008"><span class="cls_008">{{ number_format($item->weight, 2, ",", " ") . " " . config('ase.attributes.weight')[$item->weight_type]  }} </span></div>
    ...
    <div style="position:absolute;left:444.80px;top:332.40px" class="cls_008"><span class="cls_008">{{ number_format($item->net_weight, 2, ",", " ") . " " . config('ase.attributes.weight')[$item->weight_type] }} </span></div>
    ...
    <div style="position:absolute;left:415.50px;top:458.10px" class="cls_007"><span class="cls_007">TOTAL VALUE</span></div>
    <div style="position:absolute;left:415.50px;top:467.85px" class="cls_007"><span class="cls_007">AND CURRENCY</span></div>
    <div style="position:absolute;left:503.45px;top:463.10px" class="cls_010"><span class="cls_010">{{ $item->shipping_price }}</span></div>
    <div style="position:absolute;left:23.25px;top:486.85px" class="cls_005"><span class="cls_005">CUSTOM PURPOSE</span></div>
    <div style="position:absolute;left:22.50px;top:507.80px" class="cls_005"><span class="cls_005">TERMS OF PAYMENT</span></div>
    <div style="position:absolute;left:147.00px;top:507.80px" class="cls_005"><span class="cls_005">:</span></div>
    <div style="position:absolute;left:160.50px;top:507.85px" class="cls_005"><span class="cls_005">Sender Pays</span></div>
    <div style="position:absolute;left:22.50px;top:530.30px" class="cls_005"><span class="cls_005">REASON FOR SENDING</span></div>
    <div style="position:absolute;left:147.00px;top:530.30px" class="cls_005"><span class="cls_005">:</span></div>
    <div style="position:absolute;left:22.50px;top:552.80px" class="cls_005"><span class="cls_005">TERMS OF DELIVERY</span></div>
    <div style="position:absolute;left:147.00px;top:552.80px" class="cls_005"><span class="cls_005">:</span></div>
    <div style="position:absolute;left:160.50px;top:552.85px" class="cls_005"><span class="cls_005">DDU Baku</span></div>
    <div style="position:absolute;left:22.50px;top:575.30px" class="cls_005"><span class="cls_005">COUNTRY OF ORIGIN</span></div>
    <div style="position:absolute;left:147.00px;top:575.30px" class="cls_005"><span class="cls_005">:</span></div>
    <div style="position:absolute;left:160.50px;top:575.35px" class="cls_005"><span class="cls_005">{{ ($item->warehouse && $item->warehouse->country) ? (isset($item->warehouse->country->translate('en')->name) ? $item->warehouse->country->translate('en')->name : $item->warehouse->country->name) : "-" }}</span></div>
    <div style="position:absolute;left:22.50px;top:592.35px" class="cls_009"><span class="cls_009">The exporter of product covered by this document (customs autorization No:…………..….…….)</span></div>
    <div style="position:absolute;left:22.50px;top:603.75px" class="cls_009"><span class="cls_009">declares that, except where otherwise clearly indicated , these products are of {{ ($item->warehouse && $item->warehouse->country) ? (isset($item->warehouse->country->translate('en')->name) ? $item->warehouse->country->translate('en')->name : $item->warehouse->country->name) : "-" }} preferential origin.</span></div>
    <div style="position:absolute;left:371.25px;top:632.30px" class="cls_005"><span class="cls_005">Place and Date:</span></div>
    <div style="position:absolute;left:371.25px;top:648.05px" class="cls_005"><span class="cls_005">Name:</span></div>
    <div style="position:absolute;left:371.25px;top:667.55px" class="cls_005"><span class="cls_005">Signature:</span></div>
</div>
