                            ...
                            <div class="col-lg-6">
                                    ...
                                    <div class="col-sm-12 col-lg-6">
                                        ...
                                        <select class="form-control" name="length_unit">
                                            @foreach(config('ase.attributes.length') as $key => $unit)
                                                <option @if (Request::get('length_unit') == $key) selected
                                    ...
                                    <div class="col-sm-12 col-lg-6">
                                        ...
                                        <select class="form-control" name="weight_unit">
                                            @foreach(config('ase.attributes.weight') as $key => $unit)
                                                <option @if (Request::get('weight_unit') == $key) selected
                                                        @endif value="{{ $key }}">{{ $unit }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12 text-center">
                                        ...
                                        <button type="reset"
                                                class="btn btn-primary">{{ __('front.calculator.reset_all') }}</button>
                                    </div>
                                </div>
                                {{ Form::close() }}
                            </div>
