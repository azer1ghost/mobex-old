                    ...
                    <div style="min-height: 250px;" class="table-responsive"
                        ...
                        <table class="table table-hover responsive table-bordered">
                            ...
                            @forelse($items as $row => $item)
                                ...
                                @endif
                                <tr
                                    @if((isset($_colorCondition) && is_array($_colorCondition) && $item->{$_colorCondition['key']} == $_colorCondition['value']) || (isset($_view['colorCondition']) && is_array($_view['colorCondition']) && $item->{$_view['colorCondition']['key']} == $_view['colorCondition']['value'])) style="background: #ffcccc" @endif>
                                    @if (isset($_view['checklist']))
                                        <td>
