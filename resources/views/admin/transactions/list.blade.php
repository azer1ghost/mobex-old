            ...
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    ...
                    <div style="min-height: 250px;" class="table-responsive"
                         @if(isset($items) && $items->count() == 1) style="padding-bottom: 160px" @endif>

                        <div class="row">
                            <div class="col-lg-3">
                                <div class="card text-center bg-blue-400 has-bg-image">
                                    <div class="card-body">
                                        <h6 class="font-weight-semibold mb-0 mt-1">Transactions</h6>
                                    </div>

                                    <div class="card-body border-top-0 pt-0">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="text-uppercase font-size-xs">Outcome</div>
                                                <h5 class="font-weight-semibold line-height-1 mt-1 mb-0">{{ $outcome['count'] }}</h5>
                                            </div>

                                            <div class="col-lg-4">
                                                <div class="text-uppercase font-size-xs">Income</div>
                                                <h5 class="font-weight-semibold line-height-1 mt-1 mb-0">{{ $income['count'] }}</h5>
                                            </div>

                                            <div class="col-lg-4">
                                                <div class="text-uppercase font-size-xs">Total</div>
                                                <h5 class="font-weight-semibold line-height-1 mt-1 mb-0">{{ $total['count'] }}</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-5">
                                <div class="card text-center bg-purple-400 has-bg-image">
                                    <div class="card-body">
                                        <h6 class="font-weight-semibold mb-0 mt-1">Types</h6>
                                    </div>

                                    <div class="card-body border-top-0 pt-0">
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="text-uppercase font-size-xs">Cash</div>
                                                <h5 class="font-weight-semibold line-height-1 mt-1 mb-0">{{ isset($types['CASH']) ? round($types['CASH'], 2) : '0' }} AZN</h5>
                                            </div>

                                            <div class="col-lg-3">
                                                <div class="text-uppercase font-size-xs">PayTR</div>
                                                <h5 class="font-weight-semibold line-height-1 mt-1 mb-0">{{ isset($types['PAY_TR']) ? round($types['PAY_TR'], 2) : '0' }} AZN</h5>
                                            </div>

                                            <div class="col-lg-3">
                                                <div class="text-uppercase font-size-xs">PortManat</div>
                                                <h5 class="font-weight-semibold line-height-1 mt-1 mb-0">{{ isset($types['PORTMANAT']) ? round($types['PORTMANAT'], 2) : '0' }} AZN</h5>
                                            </div>

                                            <div class="col-lg-3">
                                                <div class="text-uppercase font-size-xs">Terminal</div>
                                                <h5 class="font-weight-semibold line-height-1 mt-1 mb-0">{{ isset($types['POST_TERMINAL']) ? round($types['POST_TERMINAL'], 2) : '0' }} AZN</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card text-center bg-teal-400 has-bg-image">
                                    <div class="card-body">
                                        <h6 class="font-weight-semibold mb-0 mt-1">Amount</h6>
                                    </div>
                                    ...
                                    <div class="card-body border-top-0 pt-0">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="text-uppercase font-size-xs">Outcome</div>
                                                <h5 class="font-weight-semibold line-height-1 mt-1 mb-0">{{ round($outcome['amount'], 2) }} AZN</h5>
                                            </div>

                                            <div class="col-lg-4">
                                                <div class="text-uppercase font-size-xs">Income</div>
                                                <h5 class="font-weight-semibold line-height-1 mt-1 mb-0">{{ round($income['amount'], 2) }} AZN</h5>
                                            </div>

                                            <div class="col-lg-4">
                                                <div class="text-uppercase font-size-xs">Total</div>
                                                <h5 class="font-weight-semibold line-height-1 mt-1 mb-0">{{ round($total['amount'], 2) }} AZN</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                @if(isset($_view['sum']))
                                    @foreach($_view['sum'] as $sumKey)
                                        @if(${"_total_" . $sumKey['key']})
                                            ...
                                            @if($sumKey['skip'] )
                                                <td colspan="{{ $sumKey['skip'] }}" style="text-align: center"></td>
                                            @endif
                                            <td>
